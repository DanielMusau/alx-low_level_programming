...
/**
 * shash_table_set - adss a hash (key, value) to a given shash table.
 *
 * @ht: pointer to the shash table.
 * @key: key of the shash.
 * @value: value to stpre.
 * Return: 1 if successfull, 0 if fails.
 */
...
/**
 * shash_table_print - prinst the keys and values of the shash table.
 *
 * @ht: pointer to the shash table.
 * Return: No return.
 */
